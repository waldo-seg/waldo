...
class CoreConfig:
    ...
    def __init__(self):
        ...
        #    offsets += [(x,y)]
        # print(offsets)
        self.offsets = [(1, 0), (0, 1), (-2, -1), (1, -2), (3, 2),
                        (-4, 3), (-4, -7), (10, -4), (3, 15), (-21, 0)]
    ...
    def validate(self, train_image_size=None):
        ...
        assert (train_image_size is None) or (train_image_size >
                                              0 and train_image_size > 4 * self.padding)
